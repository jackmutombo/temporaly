...
export interface ISoilSampleProps {
  status: boolean;
  onClose?: any;
}

export function SoilSampleModal(props: ISoilSampleProps) {
  ...
  const steps = [
    ...
    { key: 'Step3', component: <Step3 register={register} /> },
    {
      ...
      submitButtonTitle: 'Add Soil Sample',
    },
  ];
  return (
    <>
      ...
      >
        <Modal.Body>
          ...
          >
            <Modal.Title className='w-100'>Add Soil Sample</Modal.Title>
          </Modal.Header>
